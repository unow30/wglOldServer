...
module.exports ={
    start: function(){
        //매일 새벽 00:00 에 진행
        try{
            const job = schedule.scheduleJob('0 0 14 * * *', function (){
                mysqlUtil.connectPool(async function (db_connection) {
                    ...
                    for( let idx in item ){
                        ...
                        // let bootpay_response = await axios.put('3.34.65.237:3456/api/public/order/cancel/gift', {
                        let bootpay_response = await axios.put('52.78.124.248:3456/api/public/order/cancel/gift', {
