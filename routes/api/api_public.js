...
app.route('/user/signup/check').get( require('./legacy/origin/user/selectSignUpCheck') )
app.route('/user/email/check').get( require('./legacy/origin/user/selectUserEmailCheck') )
app.route('/user/nickname/check').get( require('./legacy/origin/user/selectUserNicknameCheck') )
app.route('/user/phone/check').get( require('./legacy/origin/user/selectUserPhoneCheck') )
app.route('/user/recommendee/code/check').get( require('./legacy/origin/user/selectUserRecommendeeCodeCheck') )
app.route('/user/profile/list').get(  require('./legacy/origin/user/selectUserProfileList') )// 새 리뷰 리스트. 상품,영상,리뷰가 전부 나온다.
app.route('/user/info/other').get( require('./legacy/origin/user/selectUserInfoOther') )
...
app.route('/v2/user/interests/all').get(  require('./legacy/v2/user/v2SelectUserInterests') ) // 22. 10. 25 v2 관심키워드 모두 가져오기 api
app.route('/v2/user/info/review').get( require('./legacy/v2/user/v2SelectUserInfoReview') ) // 22. 10. 28 v2 유저 페이지 리뷰 리스트 api
app.route('/v2/user/info/product').get( require('./legacy/v2/user/v2SelectProfileProduct')) // 23. 01. 09 유저 페이지 판매상품 리스트 api
/**
 * file api
 */
 ...
 * app version check
 */
app.route('/app/version/check').get(require('./legacy/origin/appCheck/selectAppCheck'))

/**
 * comment api
 */
 app.route('/v2/comment/list').get( require('./legacy/v2/comment/v2SelectCommentList'))
...
app.route('/v2/product/search/list').get( require('./legacy/v2/product/v2SelectProductSearchList') )
...
app.route('/v2/searchview/category/product/list').get(require('./legacy/v2/v2SearchView/v2SelectCategoryProductList'))//카테고리 상품 리스트
...
app.route('/v2/searchview/price/range/list').get( require('./legacy/v2/v2SearchView/v2SelectSearchViewPriceRangeList'))//가격대별 상품목록 더보기
app.route('/v2/searchview/new/review/list').get( require('./legacy/v2/v2SearchView/v2SelectSearchViewNewReviewList') )// 신규리뷰 목록 더보기
app.route('/v2/searchview/gongu/feed/list').get( require('./legacy/v2/v2SearchView/v2SelectSearchViewGonguFeedList') )//공구영상 더보기
app.route('/v2/searchview/best/product/list').get( require('./legacy/v2/v2SearchView/v2SelectSearchViewBestProductList') )//인기상품 더보기
app.route('/v2/searchview/edition/list').get( require('./legacy/v2/v2SearchView/v2SelectSearchViewEditionList') )//기획전 더보기
app.route('/v2/searchview/interest/list').get( require('./legacy/v2/v2SearchView/v2SelectSearchViewInterestList') )//취향저격 더보기
app.route('/v2/searchview/delivery/free').get( require('./legacy/v2/v2SearchView/v2SelectSearchViewDeliveryFreeList') )//배송무료 더보기
app.route('/v2/searchview/integerated/search/list').get( require('./legacy/v2/v2SearchView/v2SelectSearchViewIntegratedSearchList') )//통합검색 결과
 ...
 * comment api
 */
app.route('/comment/list').get( require('./legacy/origin/comment/selectCommentList') )
 ...
 * challenge api
 */
app.route('/v2/challenge/recent/round').get(  require('./legacy/v2/challenge/v2SelectChallengeRecentRound') )

/**
 * category
 */
app.route('/v2/category/icon').get(require('./legacy/origin/category/selectCategoryIcon'))
