 ...
 module.exports = function (req, res) {
     ...
     try {
         ...
         mysqlUtil.connectPool(async function (db_connection) {
            ...
            const [last_order_data, gongu_deal_data, gongu_deadline_data, ad_list_data, hot_weggler_data, edition_data] = await Promise.all([last_order, gongu_deal, gongu_deadline, ad_list, hot_weggler, edition])
