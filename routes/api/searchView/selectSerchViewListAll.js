 ...
 module.exports = function (req, res) {
    ...
    try {
        ...
        mysqlUtil.connectPool(async function (db_connection) {
            ...
            console.log('=============================>>>>>>>>>>>2')
            console.log(req.innerBody['hot_weggler'][0].Promise)
            console.log(req.innerBody['hot_weggler'][0][0].user_uid)
            console.log(req.innerBody['hot_weggler'][0][0].Promise.user_uid)
            console.log('=============================>>>>>>>>>>>3')
