 ...
 *
 * @swagger
 * /api/private/searchview/search/list/product:
 *   get:
 *     summary: 상품 검색 정보
 *     tags: [SearchView]
 *     description: |
 *       path : /api/private/searchview/search/list/product
 *
 *       * 상품 검색 정보
 *
 *     parameters:
 ...
 *         description: 결과 정보
 *         schema:
 *           $ref: '#/definitions/SearchViewProduct'
 *       400:
...
module.exports = function (req, res) {
    ...
    try {
        ...
        mysqlUtil.connectPool(async function (db_connection) {
            ...
            req.innerBody['product_list'] = await queryUser(req, db_connection)
            deleteBody(req)
...
function queryUser(req, db_connection) {
    ...
    return mysqlUtil.queryArray(db_connection
        , 'call _dev_proc_select_search_list2'
        , [
            req.paramBody['keyword'],
            req.paramBody['random_seed'],
            req.paramBody['offset'],
