 ...
 *
 * @swagger
 * /api/private/v2/weggler/community/curious:
 *   post:
 *     summary: 커뮤니티 궁금해요 게시물 생성
 *     tags: [Weggler]
 *     description: |
 *       path : /api/private/v2/weggler/community/curious
 *
 *       * 커뮤니티 궁금해요 게시물 생성
 *       * type: 1: 끄적끄적, 2: 위글꿀팁, 3: 궁금해요 
 *       * 글만 작성의 경우 => { title: blah, representative_content: 안녕하세요, representative_filename: 빈배열이든 null이든 상관 없음, images: [] 빈 문자열 꼭 넣어줄것}
 *       * 글+이미지 작성의 경우 => { title: blah, representative_content: 안녕하세요, representative_filename: abcd.abcd.jpg, images: [abcd.jpg, abcde.jpeg] }
 *     parameters:
 *       - in: body
 *         name: body
 *         description: |
 ...
 *               items:
 *                 type: string
 *               example: [abcd.jpg, abcdf.jpeg, abcde.jpg]
 *                 
 *
 *     responses:
 *       200:
 ...
 */
 ...
 module.exports = function (req, res) {
     ...
     try{
         ...
         mysqlUtil.connectPool( async function (db_connection) {
             ...
             else if(req.paramBody['images'][0] && dayPost.length < 11){
 ...
 function query(req, db_connection) {
     ...
     return mysqlUtil.querySingle(db_connection
         , 'call proc_create_community_curious_text_v2'
         , [
 ...
 function queryAll(req, db_connection) {
     ...
     return mysqlUtil.querySingle(db_connection
         , 'call proc_create_community_curious_all_v2'
         , [
             req.headers['user_uid'],
             req.paramBody['title'],
             req.paramBody['representative_content'],
 ...
 async function queryImagesBulkInsert(req, db_connection) {
     ...
     const bulkQuery = `
         insert into tbl_post_contents(post_uid, filename)
         values ?;
     `
