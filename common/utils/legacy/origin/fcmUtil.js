...
axios.defaults.headers.common["Authorization"] =
  "key=AAAAH1HxpKo:APA91bEGjPgOgXK2xZ-uqZHiR_PT69tO4knZt6ZCRpAXRESsnuY23MXWFneIQ-EALixYNkcUZg0iNczMW8eXc9ZLp6_dd1Kmz0t4rw5rJwboLwG-65hS0nyNps5OchEw72zP8dzlLNIa";
...
module.exports = {
  ...
  fcmReviewVideoSingle: async function (item) {
    return await axios
      ...
      .catch((e) => console.log(`fcmReviewVideoSingle error:: ${e}`));
  },
    ...
    return await axios
      .post("https://fcm.googleapis.com/fcm/send", {
        ...
        data: {
          title: "위글 추천인 포인트 알림",
          message:
            "위글 추천인 이벤트! 바로 사용 가능한 포인트를 지급하였습니다.",
