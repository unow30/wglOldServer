 ...
 *               * 3: 댓글 등록 알림
 *               * 4: 대댓글 등록 알림
 *               * 0: 문의 등록 알림 => 위글 앱 실행(위글앱으로 화면을 열 수 없는 경우)
 *               * 8: 위글가입 포인트 알림
 *               * 0: 구매 확정 알림 => 위글 앱 실행(위글앱으로 화면을 열 수 없는 경우)
 *
 *           * 판매자사이트 서버 실행
 *               * 6: 배송 시작 알림
 *               * 0: 구매 확정 요청 알림
 ...
 *               * 0: 문의 등록 알림 => qna.png
 *               * 8: 위글가입 포인트 알림 => point.png
 *               * 0: 구매 확정 알림 => order_success.png
 *
 *           * 판매자사이트 서버 실행
 *               * 6: 배송 시작 알림 => delever.png
 *               * 7: 구매 확정 요청 알림 => order_success.png
 *               * 9: 문의사항 답변 등록 알림 => qna.png
 *               * 0: 선물 기한 알림 => order.png
 *
 *           * 관리자사이트 서버 실행
 *               * 8: 위글 리뷰영상 이벤트 심사 승인 => review.png
 *               * 0: 위글 리뷰영상 이벤트 심사 거절 => review.png
 */
